...
@airpaas/cli/0.2.6 darwin-x64 node-v16.13.1
$ air --help [COMMAND]
USAGE
  $ air COMMAND
...
...
_See code: [src/commands/component.js](https://github.com/airpaas/cli/blob/v0.2.6/src/commands/component.js)_
...
_See code: [src/commands/config.js](https://github.com/airpaas/cli/blob/v0.2.6/src/commands/config.js)_
...
_See code: [src/commands/lib.js](https://github.com/airpaas/cli/blob/v0.2.6/src/commands/lib.js)_
<!-- commandsstop -->
